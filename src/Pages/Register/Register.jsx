...
const Register = () => {
  ...
  <form onSubmit={handleRegister} className="mt-8 mb-2 w-80 max-w-screen-lg mx-auto sm:w-96 h-full bg-transparent backdrop-blur-2xl p-10">
