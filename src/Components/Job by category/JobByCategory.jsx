...
const JobByCategory = () => {
    ...
    return (
        <div>
            ...
            <div className=''>
                <Tabs selectedIndex={tabIndex || 0} onSelect={(index) => setTabIndex(index)} className={'border-2 h-full border-red-400'}>
                    <TabList className={'flex items-center justify-center w-full h-full mx-auto border-2 border-black'}>
