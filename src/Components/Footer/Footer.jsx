    ...
    <div>
      <footer className="footer grid px-6 md:px-0 lg:px-0 xl:px-0 grid-cols-2 justify-center  md:grid-cols-4  lg:grid-cols-4 xl:grid-cols-4 pt-12 md:max-w-2xl lg:max-w-4xl xl:max-w-6xl  mx-auto text-base-content">
        <nav className="text-center flex items-center justify-center">
            <img src="https://i.ibb.co/VDryHnj/Logotype-removebg-preview.png" alt="" />
          <header className="footer-title text-center text-2xl font-bold">Job Wave</header>
        </nav>
        <nav>
          <header className="footer-title">Services</header>
          <a className="link link-hover">Branding</a>
          <a className="link link-hover">Job Creation</a>
        ...
        <form>
          ...
          <fieldset className="form-control w-full">
            ...
            <div className="relative">
              ...
              />
              <button className="btn text-white border-none bg-[#0146B1] absolute top-0 right-0 rounded-l-none">
                Subscribe
              </button>
            </div>
          </fieldset>
      ...
      <footer className="footer flex justify-between px-6 md:px-0
      lg:px-0 xl:px-0 md:max-w-2xl pb-12 lg:max-w-4xl xl:max-w-6xl  mx-auto items-center p-4 text-neutral-content">
  <aside className="items-center grid-flow-col">
    <p>Copyright © 2023 - All right reserved Job Wave</p>
  </aside> 
